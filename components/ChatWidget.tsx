  ...
  return (
    <div className="fixed bottom-5 right-5 z-[9999] flex flex-col items-end gap-3">
      ...
      <AnimatePresence>
        {isMinimized && (
          <motion.div
            ...
            onClick={handleOpen}
          >
            <span className="text-sm font-medium">AeroAI Concierge</span>
      ...
      <motion.button
        ...
        aria-label={isOpen ? "Close chat" : "Open chat with AeroAI Concierge"}
        title={isOpen ? "Close chat" : "Chat with AeroAI Concierge"}
      >
